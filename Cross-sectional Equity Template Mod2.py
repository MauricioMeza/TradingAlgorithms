...
def make_pipeline():
    ...
    valueScore = SimpleMovingAverage(inputs=[Fundamentals.value_score],window_length=3)
    ...
    smaScore_winsorized =smaScore.winsorize(min_percentile=0.1, max_percentile=0.9)
    growthScore_winsorized = growthScore.winsorize(min_percentile=0.1, max_percentile=0.9)
    valueScore_winsorized = valueScore.winsorize(min_percentile=0.1, max_percentile=0.9)
